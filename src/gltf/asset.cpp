...
//
//   mat.baseColorFactor =
//   glm::make_vec4(material.pbrData.baseColorFactor.data()); mat.metallicFactor
//   = material.pbrData.metallicFactor; mat.roughnessFactor =
//   material.pbrData.roughnessFactor; mat.emissiveFactor =
...
//                        std::byte*>(vector.bytes.data()), vector.bytes.size(),
//                        format);
//                  },
//                  [&](const fastgltf::sources::Array& array) {
//                    info = vku::TextureInfo::fromBuffer(
//                        reinterpret_cast<const
//                        std::byte*>(array.bytes.data()), array.bytes.size(),
//                        format);
//                  },
//                  [&](const fastgltf::sources::BufferView& view) {
//                    auto& buffer_view =
//                    asset.bufferViews[view.bufferViewIndex]; auto& buffer =
...
//     fastgltf::copyFromAccessor<std::uint32_t>(asset, accessor,
//     indices.data());
//   }
//
//   // --- POSITIONS ---
...
//   return Primitive{
//       .materialIdx =
//       static_cast<uint32_t>(primitive.materialIndex.value_or(0)), .indexCount
//       = static_cast<uint32_t>(indices.size()), .vertexCount =
//       static_cast<uint32_t>(vertices.size()), .indexBuffer =
//           vku::DeviceBuffer{
//               allocator_,
//               copyInfo_,
//               std::from_range,
