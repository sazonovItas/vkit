...
struct BindlessLayout final : DescriptorSetLayout {
  ...
  static constexpr auto kMaxStorageImages = std::uint32_t{256};

  static constexpr auto kSamplerBindingIdx = std::uint32_t{0};
  static constexpr auto kTexture2DBindingIdx = std::uint32_t{1};
  static constexpr auto kStorageImageBindingIdx = std::uint32_t{2};
  ...
  static constexpr auto kBindings =
      std::array<vk::DescriptorSetLayoutBinding, 3>{
          ...
          layoutBinding(kTexture2DBindingIdx, vk::DescriptorType::eSampledImage,
                        kMaxTextures, vk::ShaderStageFlagBits::eAll),

          layoutBinding(kStorageImageBindingIdx,
                        vk::DescriptorType::eStorageImage, kMaxStorageImages,
