...
void DeviceBuffer::copy(const util::RecordAndSubmitInfo& info,
                        vk::Buffer srcBuffer, std::size_t srcOffset,
                        std::size_t dstOffset, vk::DeviceSize size) {
  ...
  util::recordAndSubmit(info, copy_buffer_fn);
}
