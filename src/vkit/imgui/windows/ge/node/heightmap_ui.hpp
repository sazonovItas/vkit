...
class HeightMapNodeUI : public INodeUI {
 public:
  explicit HeightMapNodeUI(texture::TextureManager* textureManager)
      : textureManager_{textureManager} {}

  auto getName() const -> const char* override { return "Height Map"; }
