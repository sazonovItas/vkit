...
class FractalGeneratorNodeUI : public INodeUI {
 public:
  explicit FractalGeneratorNodeUI(texture::TextureManager* textureManager)
      : textureManager_{textureManager} {}

  auto getName() const -> const char* override { return "Fractal Generator"; }
